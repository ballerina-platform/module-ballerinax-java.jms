...
public client class BytesMessage {
    *AbstractMessage;
    ...
    public function getBodyLength() returns int | error {
        return externGetBodyLength(self.jmsMessage);
    }
    ...
    public function readBytes(int? length = ()) returns byte[] | error {
        if(length is int) {
            return externReadPortionOfBytes(self.jmsMessage, length);
        } else {
            return externReadBytes(self.jmsMessage);
        }
    }
    ...
    public function readUnsignedByte() returns int | error {
        return externReadUnsignedByte(self.jmsMessage);
    }
    ...
    public function readUnsignedShort() returns int | error {
        return externReadUnsignedShort(self.jmsMessage);
    }
    ...
    public function readUTF() returns string? | error {
        handle|error val = externReadUTF(self.jmsMessage);
        if (val is handle) {
    ...
    public function writeBytes(byte[] value, int? offset = (), int? length = ()) returns error? {
        if(offset is int && length is int) {
            return externWritePortionOfBytes(self.jmsMessage, value, offset, length);
        } else {
            return externWriteBytes(self.jmsMessage, value);
        }
    }
    ...
    public function writeUTF(string value) returns error? {
        return externWriteUTF(self.jmsMessage, java:fromString(value));
    }
...
function externGetBodyLength(handle message) returns int | error = @java:Method {
    name: "getBodyLength",
    'class: "javax.jms.BytesMessage"
} external;

function externReadBoolean(handle message) returns boolean | error = @java:Method {
    name: "readBoolean",
    'class: "javax.jms.BytesMessage"
} external;

function externReadByte(handle message) returns byte | error = @java:Method {
    name: "readByte",
    'class: "javax.jms.BytesMessage"
} external;
...
function externReadFloat(handle message) returns float | error = @java:Method {
    name: "readFloat",
    'class: "javax.jms.BytesMessage"
} external;

function externReadInt(handle message) returns int | error = @java:Method {
    name: "readInt",
    'class: "javax.jms.BytesMessage"
} external;

function externReadLong(handle message) returns int | error = @java:Method {
    name: "readLong",
    'class: "javax.jms.BytesMessage"
} external;

function externReadShort(handle message) returns int | error = @java:Method {
    name: "readShort",
    'class: "javax.jms.BytesMessage"
} external;

function externReadUnsignedByte(handle message) returns int | error = @java:Method {
    name: "readUnsignedByte",
    'class: "javax.jms.BytesMessage"
} external;

function externReadUnsignedShort(handle message) returns int | error = @java:Method {
    name: "readUnsignedShort",
    'class: "javax.jms.BytesMessage"
} external;

function externReadUTF(handle message) returns handle | error = @java:Method {
    name: "readUTF",
    'class: "javax.jms.BytesMessage"
} external;

function externReset(handle message) returns error? = @java:Method {
    name: "reset",
    'class: "javax.jms.BytesMessage"
} external;

function externWriteBoolean(handle message, boolean value) returns error? = @java:Method {
    name: "writeBoolean",
    'class: "javax.jms.BytesMessage"
} external;

function externWriteByte(handle message, byte value) returns error? = @java:Method {
    name: "writeByte",
    'class: "javax.jms.BytesMessage"
} external;
...
function externWriteFloat(handle message, float value) returns error? = @java:Method {
    name: "writeFloat",
    'class: "javax.jms.BytesMessage"
} external;

function externWriteInt(handle message, int value) returns error? = @java:Method {
    name: "writeInt",
    'class: "javax.jms.BytesMessage"
} external;

function externWriteLong(handle message, int value) returns error? = @java:Method {
    name: "writeLong",
    'class: "javax.jms.BytesMessage"
} external;

function externWriteShort(handle message, int value) returns error? = @java:Method {
    name: "writeShort",
    'class: "javax.jms.BytesMessage"
} external;

function externWriteUTF(handle message, handle value) returns error? = @java:Method {
    name: "writeUTF",
    'class: "javax.jms.BytesMessage"
} external;
