...
service / on new http:Listener(9090) {
    ...
    # 
    # + return - Array of MenuItem records representing the entire menu
    resource function get menu() returns MenuItem[] {
        return menuItems;
    }

    # Retrieves details for a specific menu item by Id.
    #
    ...
    resource function get menu/[int id]() returns MenuItem|http:NotFound|http:InternalServerError {
